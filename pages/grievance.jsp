<%-- 
    Document   : grievance
    Created on : Aug 2, 2021, 10:17:51 AM
    Author     : admin
--%>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Address" name="Address"  aria-describedby="email-addon">
                   ...
                   <div class="mb-3">
                       <input type="text" class="form-control" placeholder="Mobile Number" name="Mobile" onkeypress="javascript:return isNumber(event)" maxlength="16" aria-describedby="email-addon">
                  </div>
                    <div class="mb-3">
                       <input type="email" class="form-control" placeholder="Email Id" name="Email"   aria-describedby="email-addon">
                </div>
                    <div class="mb-3">
                       <input type="text" class="form-control" placeholder="Enter your grievance" name="grievance"  aria-describedby="email-addon">
                </div>
               
                <div class="text-center">
                    <input type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" name="btn" value="submit">
                </div>
                 <div class="text-center">
