...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <!--  <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../pages/Dashboard.jsp">
        ...
        <span class="ms-1 font-weight-bold">Internet Services Provider</span>
      </a>
    </div> -->
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/Customer_Details.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Customer Details Tables</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="../pages/Payment_Details.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Payment Details Tables</span>
          </a>
        </li>
        
         <li class="nav-item">
          <a class="nav-link " href="../pages/Grievance_Details.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Customer Grievance</span>
          </a>
        </li>
        
        
        <li class="nav-item">
          <a class="nav-link  " href="../pages/Add_Plan.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
               <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g id="Rounded-Icons" transform="translate(-1716.000000, -439.000000)" fill="#FFFFFF" fill-rule="nonzero">
            ...
            <span class="nav-link-text ms-1">Add Plan</span>
          </a>
        </li>      
        <li class="nav-item">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <marquee>
           <h1 class="font-weight-bolder mb-0"  style="color:purple">Internet Services Provider</h1></marquee> 
 ...
 int total_plan=0;
       try
          ...
          Class.forName("com.mysql.jdbc.Driver");
             cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/isp","root","root");
            st=cn.createStatement();
            
            String sql="select count(*)  from customer_details";            
            ResultSet rs=st.executeQuery(sql);
            while(rs.next())
                               {
            total_cust=rs.getInt(1);
            }
            
            
            sql="select count(*)  from payment_details";            
            rs=st.executeQuery(sql);
            while(rs.next())
                               {
            total_payment=rs.getInt(1);
            }
            ...
            while(rs.next())
                               {
            total_user=rs.getInt(1);
            }
            
            sql="select count(*)  from add_plan";            
            rs=st.executeQuery(sql);
            while(rs.next())
                               {
            total_plan=rs.getInt(1);
            }
            
            sql="select * from add_plan";
             rs=st.executeQuery(sql);
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                      <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Customer Details</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Payment Details</p>
                    <h5 class="font-weight-bolder mb-0">
                    <%=total_payment%>
                      <span class="text-success text-sm font-weight-bolder"></span>
                    </h5>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total User Details</p>
                    <h5 class="font-weight-bolder mb-0">
                        <%=total_user%>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                      <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Plan</p>
                    <h5 class="font-weight-bolder mb-0">
                        <%=total_plan%>
                      <span class="text-success text-sm font-weight-bolder"></span>
                    </h5>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">company</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Plan</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Speed</th>
...
%> 
                  <tbody>                 
                    <tr>
                      ...
                      <td>
                           <img src="<%=rs.getString("Image")%>" height="50px" width="50px" >
                      </td>
                      <td>
                      ...
                      <td class="align-middle">
                       <%=rs.getString("Cost")%>Rs
                      </td>
                      
                        <td class="align-middle">
                            <%=rs.getString("Duration")%> Day
                      </td>
                       
                        <td class="align-middle">
                        <a href="Add_Plan1.jsp">Edit</a>
                      </td>
                      
                       <td class="align-middle">
                           <a href="Add_Plan1.jsp">Delete</a>
                      </td>
                    </tr>
                  </tbody>
                   <%
