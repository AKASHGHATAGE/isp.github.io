  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
   <!- <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../pages/Dashboard.jsp">
        ...
        <span class="ms-1 font-weight-bold">Internet Service Provider</span>
      </a>
    </div> 
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/Customer_Details.jsp">
            ...
            <span class="nav-link-text ms-1"> Customer Details</span>
          </a>
        </li> 
        
        <li class="nav-item">
          <a class="nav-link active " href="../pages/Payment_Details.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1 active"> Payment Details</span>
          </a>
        </li> 
        ...
        <li class="nav-item">
          <a class="nav-link  "href="../pages/Add_Plan.jsp">
            ...
            <span class="nav-link-text ms-1">Add Plane</span>
          </a>
        </li>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Bank Holder Name</th>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Card No</th>
                       <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">CVV No</th>
                        ...
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm"></h6>
                               ...
                               <td>
                         <%=rs.getString("Acconut_Holder_Name")%>
                      </td>
