<%-- 
    ...
    Created on : Jul 24, 2021, 10:26:40 PM
    Author     : admin
--%>
      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
                <form  action="..\NForgot_Password" method="post">
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                  <input type="text" class="form-control" placeholder="User Name" name="UserName" aria-describedby="email-addon">
                </div>
                   <div class="mb-3">
                       <input type="text" class="form-control" placeholder="Mobile Number" name="MobileNumber" onkeypress="javascript:return isNumber(event)" maxlength="10" aria-describedby="email-addon">
                </div>
                   <div class="mb-3">
                ...
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="New Password" name="Password" aria-describedby="password-addon">
                </div>
                <div class="text-center">
                    <input type="submit"  class="btn bg-gradient-dark w-100 my-4 mb-2" name="btn" value="Save">
                </div>
