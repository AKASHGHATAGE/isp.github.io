                  ...
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Sr.No</th> 
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Plan Name</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Speed limit</th>
...
%>
                  <form name="" action="../plan_details" method="POST" >
<tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                           <%=rs.getString("A_id")%>
                           <input type="hidden" name="A_id" value=" <%=rs.getString("A_id")%>">
                          </div> 
                      ...
                      <td class="align-middle text-center">
                         ...
                         <%=rs.getString("Plan_Name")%>
                          <input type="hidden" name="Plan_Name" value=" <%=rs.getString("Plan_Name")%>">
                          </div>
                      </td>
                       <td class="align-middle text-center">
                            <div class="d-flex align-items-center justify-content-center">
                         <%=rs.getString("Speed_Limit")%>
                          <input type="hidden" name="Speed_Limit" value=" <%=rs.getString("Speed_Limit")%>">
                            </div>
                      </td>
                      <td class="align-middle text-center">
                        <div class="d-flex align-items-center justify-content-center">
