...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  active" href="../pages/userdashboard.jsp">
         ...
         <li class="nav-item">
          <a class="nav-link"    href="../pages/grievance.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                 <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g id="Rounded-Icons" transform="translate(-1716.000000, -439.000000)" fill="#FFFFFF" fill-rule="nonzero">
            ...
            <span class="nav-link-text ms-1">Grievance</span>
          </a>
        </li>                            
        <li class="nav-item">
          <a class="nav-link  " href="../pages/user_sign_in.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content mt-1 border-radius-lg">
    <!-- Navbar -->
    <marquee>
           <h1 class="font-weight-bolder mb-0"  style="color:purple">Internet Service Provider</h1></marquee>
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
         <h6 class="font-weight-bolder mb-0">Plan</h6>
        </nav>         
      </div>   
    </nav>   
    ...
    Statement st=null; 
       try
          ...
          Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from Add_Plan";            
          ...
          <div class="card">
            ...
            <div class="card-body p-3">
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">  
                      <p class="text-sm mb-0 text-capitalize font-weight-bold" name="Plan_Name"><%=rs.getString("Plan_Name")%></p>
                       <input type="hidden" name="speedlimit" value="<%=rs.getString("Speed_Limit")%>">
                    <h5 class="font-weight-bolder mb-0">
                      <%=rs.getString("Speed_Limit")%>Mbps
                      <span class="text-success text-sm font-weight-bolder"plan="Cost"><%=rs.getString("Cost")%>Rs</span>
                ...
                <div class="col-4 text-end">
                    ...
                    <h6 name="duration"><%=rs.getString("duration")%>Days</h6>
                    <input type="submit" name="btn" value="Purchase" class="btn btn-primary">
